...
FRED-driven macro market sentiment monitor — 15 indicators, 5 core questions, one signal.

## What it does

Fetches 15 key FRED series (inflation, employment, financial conditions), answers 5 core questions about macro risk, and produces:
...
| 5 | Financial conditions tightening? | NFCI + HY spread + yield curve |
